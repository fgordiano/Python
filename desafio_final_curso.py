...
def calcula_assinatura(texto):
    ...
    rel_type_token = 0
    hapax = 0
    soma_sent_caracter = 0
    soma_pal = 0
    soma_car_frase = 0
    tam_meio_frase = 0

    for i in sentencas:      
        soma_sent_caracter = soma_sent_caracter + len(i)        
        l_frases = separa_frases(i)
    ...
    meio_sentencas = soma_sent_caracter / len(sentencas)
...
def avalia_textos(textos, ass_cp):
    ...
    for texto in textos:
        ...
        result.append(compara_assinatura(ass_texto, ass_cp))
